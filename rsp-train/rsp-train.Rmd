...
The `docker run` command, you will see a list of usernames and passwords, like so:

```
# Create user chopr001 with password 123456
# Create user chopr002 with password 789012
```
...
The RStudio Server Pro will now be available by setting your browser to the public IP address
